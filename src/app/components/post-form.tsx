...
type Props = { clubId: string; post?: { id: string; title: string; body: string; discussionQuestion?: string | null } };
export function PostForm({ clubId, post }: Props) {
  ...
  return <form action={action} className="post-form">
    ...
    <label className="optional-question"><span>함께 나누고 싶은 질문 <small>선택</small></span><textarea name="discussionQuestion" defaultValue={post?.discussionQuestion ?? ""} maxLength={300} rows={3} placeholder="함께 나누고 싶은 질문" /></label>
